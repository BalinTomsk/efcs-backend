...
public static class EnvironmentAliases
{
    ...
    [
        ...
        ("WUNDERGROUND_ENABLE", "Weather:Worker:Enable:Wunderground"),
        ...
        ("WUNDERGROUND_TIMEOUT", "Weather:Worker:Timeout:Wunderground"),
        ...
        ("WUNDERGROUND_API_KEY", "Weather:Worker:WundergroundApiKey"),
        ...
        ("WUNDERGROUND_DAILY_LIMIT", "Weather:Worker:DailyLimit:Wunderground"),
